    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('company1duration', models.IntegerField(max_length=100, null=True)),
                ...
                ('company2duration', models.IntegerField(max_length=100, null=True)),
                ...
                ('company3duration', models.IntegerField(max_length=100, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('percentagepg', models.IntegerField(max_length=30, null=True)),
                ...
                ('percentagegra', models.IntegerField(max_length=30, null=True)),
                ...
                ('percentagessc', models.IntegerField(max_length=30, null=True)),
                ...
                ('percentagehsc', models.IntegerField(max_length=30, null=True)),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
    ]
