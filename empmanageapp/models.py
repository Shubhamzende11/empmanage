...
class EmployeeEducation(models.Model):
    user=models.ForeignKey(User,on_delete=models.CASCADE)
    courcepg=models.CharField(max_length=100,null=True)
    ...
    courcegra = models.CharField(max_length=100, null=True)
    ...
    courcessc = models.CharField(max_length=100, null=True)
    ...
    courcehsc = models.CharField(max_length=100, null=True)
